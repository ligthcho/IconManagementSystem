...
namespace Logic
{
	public class PinyinLogic
	{
		...
		{
			return Convert(hzString , hzString.Length);
		}
		...
		public static string Convert(string hzString , int maxLength)
		{
			...
			//hzString = hzString.Trim().Replace(" " , "_").Replace("?" , "_").Replace("\\" , "_").Replace("/" , "_").Replace(":" , "_").Replace("*" , "_").Replace(">" , "_").Replace("<" , "_").Replace("?" , "").Replace("|" , "").Replace("\"" , "'").Replace("(" , "_").Replace(")" , "_").Replace(";" , "_");
			//hzString = hzString.Replace("，" , "_").Replace("；" , "_").Replace("。" , "_").Replace("”" , "_").Replace("“" , "_").Replace("[" , "_").Replace("]" , "_").Replace("【" , "_").Replace("】" , "_");
			//hzString = hzString.Replace("{" , "_").Replace("}" , "_").Replace("^" , "_").Replace("&" , "_").Replace("=" , "_").Replace("~" , "_").Replace("@" , "_").Replace("￥" , "_");
